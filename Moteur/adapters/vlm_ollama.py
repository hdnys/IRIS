...
class OllamaVLM(ModelAdapter):
    ...
    def _run_describe(self, snap: dict) -> Optional[str]:
        ...
        system = (
            ...
            "Examples:\n"
            "  Changes: Roberto just appeared           → 'Roberto has just stepped in front of you.'\n"
            "  Changes: Elie left the view              → 'Elie is no longer in front of you.'\n"
            "  Changes: Roberto in, Elie out            → 'Elie has left and Roberto is now in front of you.'\n"
            "  Changes: 1 unrecognized person appeared  → 'Someone has just walked up to you.'\n"
            "  No changes, Roberto center, desk foreground, office, typing "
            "→ 'Roberto is at a desk directly in front of you, appearing to type.'\n"
            ...
            "  Roberto center foreground, Elie right background, both standing, corridor "
            "→ 'Roberto is right in front of you with Elie further back to your right, both standing in a corridor.'\n"
            "  No changes, no people, kitchen, kettle foreground center "
            "→ 'A kettle is directly in front of you in what looks like a kitchen.'\n"
            "  Franklin IS the person in the outline: large figure left, resting chin on hand, gazing at window, bright light "
            "→ 'Franklin is to your left, resting his chin on his hand and looking toward a bright window.'\n\n"
